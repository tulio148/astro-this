...
export default function ServicePathSelector({ paths }: Props) {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,1.05fr)] lg:items-stretch">
      ...
      <div
        className="relative min-h-[520px] overflow-hidden rounded-[2rem] border border-db-pink/10 bg-slate-950 text-white shadow-[0_28px_80px_rgba(15,23,42,0.22)]"
      >
        ...
        <div className="relative z-10 flex min-h-[520px] flex-col justify-end p-6 sm:p-8">
          ...
          <a
            href={active.href}
            className="motion-cta mt-6 inline-flex min-h-12 w-fit items-center justify-center gap-2 rounded-full bg-db-green px-6 py-3 text-xs font-black uppercase tracking-[0.16em] text-db-pink drop-shadow-[0_1px_1px_rgba(255,255,255,0.55)] transition hover:bg-white hover:text-db-pink hover:drop-shadow-none"
          >
            {active.cta}
