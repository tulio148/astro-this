              ...
              >
                {CTA_LINKS.map(({ name, path }) => (
                  <a
                    ...
                    href={path}
                    onClick={handleLinkClick}
                    className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-db-green/70 bg-db-green px-6 py-3 text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-slate-950 shadow-[0_14px_32px_rgba(0,204,129,0.25)] transition hover:-translate-y-0.5 hover:border-white hover:bg-white hover:text-db-pink"
                  >
                    {name}
